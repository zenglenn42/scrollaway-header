...
function ModelMenu(getLocale = () => {return "en-US"}) {
  ...
  this.msgCatalog = {
    ...
    "hi-IN": {
      ...
      viewBestBets: "3. आपका सबसे अच्छा चुनाव",
      viewBlog: "ब्लॉग",
      priorities: "आपकी प्राथमिकताएं",
      prioritiesEdit: "प्राथमिकताएं बदलें",
      prioritiesClear: "कैश की गई प्राथमिकताएं हटाएं",
      prioritiesDefault: "रीसेट प्राथमिकताएं",
      prioritiesHappiness: "नागरिक खुशी: %s",
      prioritiesPolitics: "राजनीतिक झुकाव: %d",
      prioritiesCost: "जीवन यापन खर्च्चा: %s" ,
      settings: "सेटिंग्स",
      settingsEdit: "सेटिंग्स को बदलें",
      settingsClear: "सेटिंग्स को हटाएं",
      settingsDefault: "रीसेट सेटिंग्स",
      useLang: "प्रयोग %s",
      showCities: "शहरों को दिखाएं %s",
